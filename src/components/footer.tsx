			...
			>
				...
				>
					...
					>
						...
						>
							<IconButton
								onClick={() => (window.location.href = 'https://www.twitter.com/daga_coin')}
								aria-label='twitter'
								icon={
									<Image
										src='/twitter.jpg'
							...
							/>
							<IconButton
								onClick={() => (window.location.href = 'https://t.me/DAGA_coin')}
								aria-label='twitter'
								icon={
									<Image
										src='/telegram.jpg'
					...
					>
						...
						>
							<IconButton
								onClick={() => (window.location.href = 'mailto:info@dagacoin.xyz')}
								_hover={{ color: '#FFFFFF', backgroundColor: 'gray.600' }}
								aria-label='contact'
								color='#000000'
								icon={<LinkIcon />}
								bg='#FFFFFF'
